...
<xs:schema xmlns=""http://BizTalk_Server_Project1.Schema1"" xmlns:b=""http://schemas.microsoft.com/BizTalk/2003"" targetNamespace=""http://BizTalk_Server_Project1.Schema1"" xmlns:xs=""http://www.w3.org/2001/XMLSchema"">
  <xs:element name=""Root"">
    <xs:complexType>
      <xs:sequence>
        <xs:element name=""test1"" type=""xs:anyType"" />
        <xs:element name=""test2"" type=""xs:anyType"" />
        <xs:element name=""test3"" type=""xs:anyType"" />
        <xs:element minOccurs=""0"" name=""test4"" type=""xs:anyType"" />
      </xs:sequence>
    </xs:complexType>
  </xs:element>
</xs:schema>";
